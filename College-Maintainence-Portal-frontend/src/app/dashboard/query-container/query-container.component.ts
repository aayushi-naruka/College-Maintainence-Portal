...
if(this.queryData!="")
    ...
    if(this.title==="Electric"){ this.img_url="https://e7.pngegg.com/pngimages/598/682/png-clipart-incandescent-light-bulb-halogen-lamp-drawing-light-blue-light-fixture-lamp.png"}
    if(this.title==="Cleaning"){ this.img_url="https://static.vecteezy.com/system/resources/previews/011/564/365/non_2x/eps10-blue-abstract-broom-cleaning-dust-solid-icon-isolated-on-white-background-hygiene-symbol-in-a-simple-flat-trendy-modern-style-for-your-website-design-logo-and-mobile-application-vector.jpg"}
    if(this.title==="Plumbing"){ this.img_url="https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/08/plumbing-logos.jpg"}
